...
SPECS: list[ModelSpec] = [
    ...
    ModelSpec("fastvit_sa36", "fastvit_sa36.apple_dist_in1k.pth", "fastvit_sa36.apple_dist_in1k"),
    ...
    ModelSpec("mobilenetv4_hyper", "mobilenetv4_hybrid_large.pth", "mobilenetv4_hybrid_large"),
